...
var eleNav = document.getElementById('nav-bar');
 if (ele.classList.contains('show-menu')) {
      ...
      document.getElementsByClassName('menuBtn')[0].setAttribute("src","images/close-icon.png");
      ...
      document.getElementsByClassName('menuBtn')[0].setAttribute("src","images/menu-icon.png");
